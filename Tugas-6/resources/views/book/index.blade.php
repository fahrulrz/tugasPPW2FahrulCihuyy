    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3" class="table-primary" style="font-weight: bold">{{$jumlahBuku}}</td>
            </tr>
            <tr>
                <td colspan="4" class="table-primary" style="text-align: center; font-weight: bold">Total Harga</td>
                <td colspan="3" class="table-success" style="font-weight: bold">{{"Rp. ".number_format($totalHarga, 2, ",", ".")}}</td>
            </tr>
        </tbody>
      </table>
